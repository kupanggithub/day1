...
console.log('Second Word: ' + secondWord + secondWord.length );
console.log('Third Word: ' + thirdWord + thirdWord.length);
console.log('Fourth Word: ' + fourthWord + fourthWord.length);
console.log('Fifth Word: ' + fifthWord + fifthWord.length);